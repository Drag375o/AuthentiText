...
module.exports = {
  ...
  safelist: ["sig-low", "sig-mid", "sig-high", "field-input", "field-checkbox", "field-select", "editor-title", "editor-textarea", "editor-over-limit", "btn-danger", "btn-danger-ghost", "confirm-dialog", "is-closing", "rename-trigger", "rename-flash", "tab", "dropzone", "is-dragover", "is-busy", "upload-chip", "is-indeterminate", "is-highlighted", "sentence-row", "text-justify", "hyphens-auto", "text-rule", "text-brass", "chip", "chip--marker", "activity", "activity-col", "activity-bar", "is-empty", "attention-dot", "attention-dot--warn", "attention-dot--high", "attention-dot--ok", "profile-track", "profile-range", "profile-dot", "profile-median", "diff-removed", "diff-added", "delta-up", "delta-down", "pattern-mark", "strength", "summary-text"],
  theme: {
    extend: {
      colors: {
        paper: "#FFFFFF",
