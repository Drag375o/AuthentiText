...
FEATURES: list[FeatureSpec] = [
    ...
    FeatureSpec("heading_count", "document", "Headings", "count",
                "Short lines without sentence-ending punctuation. They are counted in the sentence-length measures along with everything else."),
    ...
    FeatureSpec("sentence_length_mean", "document", "Mean sentence length", "words", "Average words per sentence, headings included."),
    ...
    FeatureSpec("sentence_length_cv", "document", "Sentence length variation", "ratio",
                "Spread divided by the mean, so texts with long and short average sentences can be compared. Low variation is common in careful editing as well as generated text; it isn't evidence on its own.", unavailable="Needs at least one sentence."),
    ...
    FeatureSpec("sentence_length_burstiness", "statistical", "Burstiness", "number",
                "Unevenness of sentence lengths on a scale from -1 to +1 (Goh & Barabasi, 2008). -1 is perfectly regular, 0 is random-like, and positive values mean bursts of short and long sentences. Regular rhythm alone is not evidence of anything.", unavailable="Needs at least three sentences."),
